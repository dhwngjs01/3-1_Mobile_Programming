package com.example.a20230417_android_gridview;
...
public class MainActivity extends AppCompatActivity {
    ...
    public class ImageAdapter extends BaseAdapter {
        ...
        private Integer[] mThumbIds = {
                R.drawable.img_1, R.drawable.img_2, R.drawable.img_3, R.drawable.img_4,R.drawable.img_5,R.drawable.img_6,R.drawable.img_7,R.drawable.img_8,R.drawable.img_9,
        };
        ...
        public View getView(int position, View convertView, ViewGroup parent){
            ...
            if(convertView == null){
                ...
                objImgView.setLayoutParams(new ViewGroup.LayoutParams(85, 85));
